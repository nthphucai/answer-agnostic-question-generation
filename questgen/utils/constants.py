...
PARENT_PATH = Path(questgen.__file__).parent
SCRIPT_PATH = os.path.join(
    PARENT_PATH,
    "dataset/build_transformer_format_dataset/build_transformer_format_dataset.py",
)
VI_VECTOR_PATH = os.path.join(PARENT_PATH, "pipelines/modules/summarize/vi.vec")
STOPWORD_PATH = os.path.join(PARENT_PATH, "dataset/create_data/history_stopwords.npy")
